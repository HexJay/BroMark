package com.jay.domain.strategy.service.armory.algorithm.impl;


import com.jay.domain.strategy.model.entity.StrategyAwardEntity;
import com.jay.domain.strategy.service.armory.algorithm.AbstractAlgorithm;
...
public class OLogNAlgorithm extends AbstractAlgorithm {
    ...
    public Integer dispatchAlgorithm(String key) {
        ...
        Map<Map<String, Integer>, Integer> table  = new HashMap<>();
