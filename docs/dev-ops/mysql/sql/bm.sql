...
CREATE TABLE `big_market`.`strategy`
(
...
LOCK TABLES `big_market`.`strategy` WRITE;

INSERT INTO `big_market`.`strategy` (`id`, `strategy_id`, `strategy_desc`, `create_time`, `update_time`)
VALUES (1, 100001, '抽奖策略', '2023-12-09 09:37:19', '2023-12-09 09:37:19');

CREATE TABLE `big_market`.`strategy_award`
(
...
LOCK TABLES `big_market`.`strategy_award` WRITE;

INSERT INTO `big_market`.`strategy_award` (`id`, `strategy_id`, `award_id`, `award_title`, `award_subtitle`,
                                           `award_count`,
                                           `award_count_surplus`, `award_rate`, `rule_models`, `sort`, `create_time`,
                                           `update_time`)
...
CREATE TABLE `big_market`.`strategy_rule`
(
    `id`          bigint(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
...
LOCK TABLES `big_market`.`strategy_rule` WRITE;

INSERT INTO `big_market`.`strategy_rule` (`id`, `strategy_id`, `award_id`, `rule_type`, `rule_model`, `rule_value`,
                                          `rule_desc`,
