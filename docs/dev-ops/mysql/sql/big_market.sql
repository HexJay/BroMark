...
VALUES (1, 'sign', '签到返利-sku额度', 'sku', '9011', 'open', '2024-04-30 09:32:46', '2024-06-01 11:04:55'),
...
INSERT INTO `raffle_activity_count` (`id`, `activity_count_id`, `total_count`, `day_count`, `month_count`,
                                     `create_time`, `update_time`)
VALUES (1, 11101, 100, 100, 100, '2024-03-09 10:15:42', '2024-05-04 13:06:45');
...
INSERT INTO `raffle_activity_sku` (`id`, `sku`, `activity_id`, `activity_count_id`, `stock_count`,
                                   `stock_count_surplus`, `product_amount`, `create_time`, `update_time`)
VALUES (1, 9011, 100301, 11101, 100000, 99890, 1.68, '2024-03-16 11:41:09', '2024-06-09 09:11:25');
...
VALUES (1, 'tree_lock_1', 'rule_lock', 'rule_stock', 'EQUAL', 'ALLOW', default, '2024-02-15 07:55:08'),
       (2, 'tree_lock_1', 'rule_lock', 'rule_luck_award', 'EQUAL', 'TAKE_OVER', default,
        '2024-02-15 07:55:11'),
       (3, 'tree_lock_1', 'rule_stock', 'rule_luck_award', 'EQUAL', 'ALLOW', default,
        '2024-02-15 07:55:13'),
       (4, 'tree_luck_award', 'rule_stock', 'rule_luck_award', 'EQUAL', 'ALLOW', '2024-02-15 07:37:31',
        '2024-02-15 07:39:28'),
       (5, 'tree_lock_2', 'rule_lock', 'rule_stock', 'EQUAL', 'ALLOW', default, '2024-02-15 07:55:08'),
       (6, 'tree_lock_2', 'rule_lock', 'rule_luck_award', 'EQUAL', 'TAKE_OVER', default,
        '2024-02-15 07:55:11'),
       (7, 'tree_lock_2', 'rule_stock', 'rule_luck_award', 'EQUAL', 'ALLOW', default,
        '2024-02-15 07:55:13'),
       (8, 'tree_lock_3', 'rule_lock', 'rule_luck_award', 'EQUAL', 'ALLOW', default,
        '2024-04-27 13:07:39'),
       (9, 'tree_lock_3', 'rule_lock', 'rule_luck_award', 'EQUAL', 'TAKE_OVER', default,
        '2024-02-15 07:55:11'),
       (10, 'tree_lock_3', 'rule_stock', 'rule_luck_award', 'EQUAL', 'ALLOW', default,
        '2024-02-15 07:55:13');
...
VALUES (1, 100001, 101, '随机积分', NULL, 80000, 79998, 0.3000, 'tree_luck_award', 1, '2023-12-09 09:38:31',
       ...
       (21, 100005, 105, '随机积分', NULL, 80000, 80000, 0.0010, 'tree_luck_award', 1, '2023-12-09 09:38:31',
        '2024-02-15 07:42:52'),
       (22, 100006, 101, '随机积分', NULL, 100, 57, 0.0200, 'tree_luck_award', 1, '2023-12-09 09:38:31',
        '2024-05-04 15:37:00'),
       (23, 100006, 102, 'OpenAI会员卡', NULL, 100, 17, 0.0300, 'tree_luck_award', 2, '2023-12-09 09:38:31',
        '2024-05-04 13:00:15'),
       (24, 100006, 103, '支付优惠券', NULL, 100, 40, 0.0300, 'tree_luck_award', 3, '2023-12-09 09:38:31',
        '2024-05-04 15:36:15'),
       (25, 100006, 104, '小米台灯', NULL, 100, 31, 0.0300, 'tree_luck_award', 4, '2023-12-09 09:38:31',
        '2024-05-04 15:36:45'),
       (26, 100006, 105, '小米su7周体验', '抽奖3次后解锁', 100, 38, 0.0300, 'tree_lock_3', 5, '2023-12-09 09:38:31',
        '2024-04-27 13:08:16'),
       (27, 100006, 106, '轻奢办公椅', '抽奖2次后解锁', 100, 23, 0.0300, 'tree_lock_2', 6, '2023-12-09 09:38:31',
        '2024-05-04 15:31:45'),
       (28, 100006, 107, '小霸王游戏机', '抽奖1次后解锁', 100, 22, 0.0300, 'tree_lock_1', 7, '2023-12-09 09:38:31',
        '2024-05-04 15:31:55'),
       (29, 100006, 108, '暴走玩偶', NULL, 100, 27, 0.0300, 'tree_luck_award', 8, '2023-12-09 09:38:31',
        '2024-05-04 15:37:05');
...
INSERT INTO `strategy_rule` (`id`, `strategy_id`, `award_id`, `rule_type`, `rule_model`, `rule_value`, `rule_desc`,
                             `create_time`, `update_time`)
VALUES (13, 100001, NULL, 1, 'rule_weight', '60:102,103,104,105 200:106,107 1000:105', '消耗6000分，必中奖范围',
        '2023-12-09 10:30:43', '2024-05-04 12:44:47'),
       ...
       (15, 100006, NULL, 1, 'rule_weight', '10:102,103 70:106,107 1000:104,105', '消耗6000分，必中奖范围',
        '2023-12-09 10:30:43', '2024-05-04 15:41:16'),
