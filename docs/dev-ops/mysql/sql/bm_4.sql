...
VALUES
    (1,101,'user_credit_random','1,100','用户积分【优先透彻规则范围，如果没有则走配置】',default,default),
...
VALUES
    (1,'tree_lock_1','规则树','规则树','rule_lock',default,default),
...
VALUES
    (1,'tree_lock_1','rule_lock','限定用户已完成N次抽奖后解锁','1',default,default),
...
VALUES
    (1,'tree_lock_1','rule_lock','rule_stock','EQUAL','ALLOW',default,default),
...
VALUES
    (1,100001,'抽奖策略','rule_blacklist,rule_weight',default,default),
...
VALUES
    (1,100001,101,'随机积分',NULL,80000,80000,0.3000,'tree_luck_award',1,default,default),
    ...
    (7,100001,107,'增加dall-e-3画图模型','抽奖1次后解锁',200,200,0.0400,'tree_luck_award',7,default,default),
    ...
    (13,100003,107,'增加dall-e-3画图模型','抽奖1次后解锁',200,200,0.0400,'tree_luck_award',7,default,default),
...
VALUES
    (1,100001,101,2,'rule_random','1,1000','随机积分策略',default,default),
    ...
    (13,100001,NULL,1,'rule_weight','4000:102,103,104,105 5000:102,103,104,105,106,107 6000:102,103,104,105,106,107,108,109','消耗6000分，必中奖范围',default,default),
